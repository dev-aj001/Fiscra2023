...
public class ModificarUsuarios extends javax.swing.JFrame {
    ...
    Usuarios formUs;
    String strPassReset = "123456";
    Usuario usuario = null;
    
    public ModificarUsuarios(int id, Usuarios us) {
        initComponents();
        this.id = id;
                ...
                .addGroup(pnlDatos5Layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
                    ...
                    .addGroup(javax.swing.GroupLayout.Alignment.TRAILING, pnlDatos5Layout.createSequentialGroup()
                        ...
                        .addGroup(pnlDatos5Layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING, false)
                            .addComponent(rol, 0, 143, Short.MAX_VALUE)
    ...
    private void jButton1ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton1ActionPerformed
        int i = JOptionPane.showConfirmDialog(rootPane, "¿Desea reestablcer la contraseña de este usuario?");
        if(i==JOptionPane.OK_OPTION){
            usuario.setContrasena(strPassReset);
        }
    ...
    public void escribirDatos(){
        ...
        Usuario us = cp.getUsuario(id);
        txtNombre.setText(us.getNombre());
        txtApellidoPa.setText(us.getApellidoPa());
        txtApellidoMa.setText(us.getApellidoMa());
        txtDireccion.setText(us.getDireccion());
        txtCorreo.setText(us.getCorreo());
        txtTelefon.setText(us.getTelefono());
        txtUsuario.setText(us.getUsuario());
        
        dateChooser.setDate(us.getFechaNac());
        
        if("Empleado".equals(us.getRol())){
            rol.setSelectedIndex(0);
        }else{
            rol.setSelectedIndex(1);
        }
        
        if("Hombre".equals(us.getSexo())){
            sexo.setSelectedIndex(0);
        }else if("Mujer".equals(us.getSexo())){
