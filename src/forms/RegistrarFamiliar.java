 ...
 * @author linit
 */
public class RegistrarFamiliar extends javax.swing.JFrame {
    
    
    Familiares formus;
    public RegistrarFamiliar(Familiares formus) {
        initComponents();
        this.formus=formus;
    }
    ...
    private void btnOkActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btnOkActionPerformed
        ...
        cp.registrarFamiliar(familiar);
        formus.actualizarTabla();
        JOptionPane.showMessageDialog(null, "Se agrego Familiar nuevo exitosamente");
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(RegistrarFamiliar.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
