...
public class AgregarActividad extends javax.swing.JFrame {
    ...
    AgendaActividades Ga;
    public AgregarActividad(AgendaActividades Ga) {
        initComponents();
        this.Ga=Ga;
    }
    ...
    private void jButton4ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton4ActionPerformed
        Agendaactividades agendaactividades = new Agendaactividades( 0);
        ...
        cp.registraragenda(agendaactividades);
        Ga.actualizarTabla();
        JOptionPane.showMessageDialog(null, "Se agrego una nueva actividad  exitosamente");
