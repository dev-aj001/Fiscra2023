 ...
 * @author jairi
 */
public class AgendaActividades extends javax.swing.JPanel {
    
    private static AgendaActividades instance;

    /**
     * Creates new form Pacientes
     */
    private AgendaActividades() {
        initComponents();
        setOpaque(false);
    ...
    //Singleton
    public static AgendaActividades getInstance(){
        if(instance == null){
            instance = new AgendaActividades();
        }
        return instance;
    }
    ...
    public void actualizarTabla() {
        try {
            ...
            List<Agendaactividades> listAgendaactividades =  jpa.getListAgendaactividades();
        
            for (Agendaactividades agenda : listAgendaactividades) {
    ...
    private void eliminar() {
        ...
        int op = JOptionPane.showConfirmDialog(null, "desea la actividad con el id: "+ id);
        if(op==JOptionPane.OK_OPTION){
            try {
                cp.eliminaragenda(id);
                JOptionPane.showMessageDialog(null, "se elimino exitosamente");
                actualizarTabla();
            } catch (NonexistentEntityException ex) {
                Logger.getLogger(AgendaActividades.class.getName()).log(Level.SEVERE, null, ex);
            }
        }
    }
}
